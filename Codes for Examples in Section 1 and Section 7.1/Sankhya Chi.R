...
plot(rectangle_eg[c(1, 2, 4, 3, 1), 1] - rectangle_eg[3, 1], 
     rectangle_eg[c(1, 2, 4, 3, 1), 2] - rectangle_eg[3, 2],
     asp = 1, xlim = c(-2, 18),
     xlab = '', ylab = '', type = 'l', lwd = 2, axes = F)
points(rectangle_eg[, 1] - rectangle_eg[3, 1], 
       rectangle_eg[, 2] - rectangle_eg[3, 2], pch = 19)
text(c(rectangle_eg[1, 1] - rectangle_eg[3, 1] - 0.3,
       rectangle_eg[2, 1] - rectangle_eg[3, 1] + 0.3,
       rectangle_eg[3, 1] - rectangle_eg[3, 1] - 0.3,
       rectangle_eg[4, 1] - rectangle_eg[3, 1] + 0.3), 
     c(rectangle_eg[1:2, 2] - rectangle_eg[3, 2] + 0.5,
    rectangle_eg[3:4, 2] - rectangle_eg[3, 2] - 0.5), 
    c(4, 3, 1, 2), cex = 1.2)
arrows(-2, 0, 18, 0, lwd = 2)
arrows(0, 0, 0, 9, lwd = 2)
text(18, -0.5, 'x', cex = 1.2)
...
plot(rectangle_register[c(1, 2, 4, 3, 1), 1], 
